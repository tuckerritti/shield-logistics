...
describe('Apply Action', () => {
  ...
  describe('Fold action', () => {
    it('should mark player as folded', () => {
      ...
      const foldedPlayer = result.updatedPlayers.find(p => p.seat_number === 2);
  ...
  describe('Call action', () => {
    it('should match current bet', () => {
      ...
      const callingPlayer = result.updatedPlayers.find(p => p.seat_number === 1);
    ...
    it('should handle call when player already has partial bet', () => {
      const players = [
        createPlayer({ seat_number: 1, current_bet: 5, chip_stack: 495, total_invested_this_hand: 5 }),
        createPlayer({ seat_number: 2, current_bet: 15, chip_stack: 485, total_invested_this_hand: 15 })
      ];
  ...
  describe('Raise action', () => {
    ...
    it('should handle raise when player already has partial bet', () => {
      const players = [
        createPlayer({ seat_number: 1, current_bet: 50, chip_stack: 450, total_invested_this_hand: 50 }),
        createPlayer({ seat_number: 2, current_bet: 10, chip_stack: 490, total_invested_this_hand: 10 })
      ];
  ...
  describe('All-in action', () => {
    it('should bet all remaining chips', () => {
      ...
      const allInPlayer = result.updatedPlayers.find(p => p.seat_number === 1);
    ...
    it('should mark player as all-in when raising all chips', () => {
      ...
      const allInPlayer = result.updatedPlayers.find(p => p.seat_number === 2);
      expect(allInPlayer?.chip_stack).toBe(0);
    ...
    it('should build correct side pots across all-in and calls during a street', () => {
      ...
      let ctx: ActionContext = { room: standardRoom, players, gameState, fullBoard1, fullBoard2 };
